...
const char kCustomScreenHeight[]            = "custom-screen-height";
const char kCustomScreenAvailWidth[]        = "custom-screen-avail-width";
const char kCustomScreenAvailHeight[]       = "custom-screen-avail-height";
const char kCustomScreenAvailLeft[]         = "custom-screen-avail-left";
const char kCustomScreenAvailTop[]          = "custom-screen-avail-top";
const char kCustomScreenColorDepth[]        = "custom-screen-color-depth";
const char kCustomScreenPixelDepth[]        = "custom-screen-pixel-depth";

const char kCustomNavigatorPlatform[]       = "custom-navigator-platform";
const char kCustomNavigatorHardwareConcurrency[] = "custom-navigator-hardware-concurrency";
const char kCustomNavigatorDeviceMemory[]   = "custom-navigator-device-memory";
