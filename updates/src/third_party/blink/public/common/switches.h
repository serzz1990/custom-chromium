...
BLINK_COMMON_EXPORT extern const char kCustomScreenHeight[];
BLINK_COMMON_EXPORT extern const char kCustomScreenAvailWidth[];
BLINK_COMMON_EXPORT extern const char kCustomScreenAvailHeight[];
BLINK_COMMON_EXPORT extern const char kCustomScreenAvailLeft[];
BLINK_COMMON_EXPORT extern const char kCustomScreenAvailTop[];
BLINK_COMMON_EXPORT extern const char kCustomScreenColorDepth[];
BLINK_COMMON_EXPORT extern const char kCustomScreenPixelDepth[];

BLINK_COMMON_EXPORT extern const char kCustomNavigatorPlatform[];
BLINK_COMMON_EXPORT extern const char kCustomNavigatorHardwareConcurrency[];
BLINK_COMMON_EXPORT extern const char kCustomNavigatorDeviceMemory[];
